(module
 ...
 (data (i32.const 8919) "active")
 (data (i32.const 8925) "string is too long to be a valid name\00")
 (data (i32.const 8963) "thirteenth character in name cannot be a letter that comes after j\00")
 (data (i32.const 9030) "character is not in allowed character set for names\00")
 (data (i32.const 9082) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 9133) "error reading iterator\00")
 (data (i32.const 9156) "read\00")
 (data (i32.const 9161) "cannot create objects in table of another contract\00")
 (data (i32.const 9212) "write\00")
 (data (i32.const 9218) "object passed to modify is not in multi_index\00")
 (data (i32.const 9264) "cannot modify objects in table of another contract\00")
 (data (i32.const 9315) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 9374) "attempt to add asset with different symbol\00")
 (data (i32.const 9417) "addition underflow\00")
 (data (i32.const 9436) "addition overflow\00")
 (data (i32.const 9454) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9502) "subtraction underflow\00")
 (data (i32.const 9524) "subtraction overflow\00")
 (data (i32.const 9545) "cannot pass end iterator to modify\00")
 (data (i32.const 9580) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 9629) "cannot pass end iterator to erase\00")
 (data (i32.const 9663) "cannot increment end iterator\00")
 (data (i32.const 9693) "object passed to erase is not in multi_index\00")
 (data (i32.const 9738) "cannot erase objects in table of another contract\00")
 (data (i32.const 9788) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9841) "get\00")
 (table $0 7 7 anyfunc)
