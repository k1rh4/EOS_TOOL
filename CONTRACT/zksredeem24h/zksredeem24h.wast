(module
 ...
 (memory $0 1)
 (data (i32.const 8192) "\10\c2\90J%u1\fc \c2\90J%u1\fc0\c2\90J%u1\fc@\c2\90J%u1\fcP\c2\90J%u1\fc\10\c2\90J%u1\fc \c2\90J%u1\fc0\c2\90J%u1\fc@\c2\90J%u1\fcP\c2\90J%u1\fc")
 ...
 (data (i32.const 9035) "must redeem at least 100 ZKS or 100.0000 ZKSPLAY\00")
 (data (i32.const 9084) "<ZKS spent: \00")
 (data (i32.const 9097) ">\00")
 (data (i32.const 9099) "<Creditor has balance \00")
 (data (i32.const 9122) "creditor does not have enough resources, please try again later\00")
 (data (i32.const 9186) "creditorperm\00")
 (data (i32.const 9199) "eosio\00")
 (data (i32.const 9205) "delegatebw\00")
 (data (i32.const 9216) "<Running check>\00")
 (data (i32.const 9232) "bankperm\00")
 (data (i32.const 9241) "write\00")
 (data (i32.const 9247) "-%lld.%s %s\00")
 (data (i32.const 9259) "%lld.%s %s\00")
 (data (i32.const 9270) "cannot create objects in table of another contract\00")
 (data (i32.const 9321) "next primary key in table is at autoincrement limit\00")
 (data (i32.const 9373) "cannot decrement end iterator when the table is empty\00")
 (data (i32.const 9427) "cannot decrement iterator at beginning of table\00")
 (data (i32.const 9475) "unable to find key\00")
 (data (i32.const 9494) "undelegatebw\00")
 (data (i32.const 9507) "expireorder\00")
 (data (i32.const 9519) "order entry not found!!!\00")
 (data (i32.const 9544) "cannot pass end iterator to erase\00")
 (data (i32.const 9578) "object passed to erase is not in multi_index\00")
 (data (i32.const 9623) "cannot erase objects in table of another contract\00")
 (data (i32.const 9673) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9726) "order entry not found!\00")
 (data (i32.const 9749) "order not yet expired\00")
 (data (i32.const 9771) "get\00")
