(module
 ...
 (data (i32.const 8919) "must add positive quantity\00")
 (data (i32.const 8946) "must reduce positive quantity\00")
 (data (i32.const 8976) "reduce too much\00")
 (data (i32.const 8992) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 9043) "error reading iterator\00")
 (data (i32.const 9066) "read\00")
 (data (i32.const 9071) "cannot create objects in table of another contract\00")
 (data (i32.const 9122) "write\00")
 ...
 (table $0 9 9 anyfunc)
 (elem (i32.const 1) $20 $17 $13 $1 $15 $19 $10 $5)
 ...
 (func $20 (; 59 ;) (type $4) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  (local $6 i64)
