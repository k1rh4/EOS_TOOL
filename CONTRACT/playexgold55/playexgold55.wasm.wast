(module
 ...
 (data (i32.const 400) "token with symbol does not exist, create token before issue\00")
 ...
 (data (i32.const 608) "attempt to add asset with different symbol\00")
 (data (i32.const 656) "addition underflow\00")
 (data (i32.const 688) "addition overflow\00")
 ...
 (data (i32.const 816) "must issue positive quantity\00")
 (data (i32.const 848) "symbol precision mismatch\00")
 (data (i32.const 880) "quantity exceeds available supply\00")
 ...
 (table $0 5 5 anyfunc)
 (elem (i32.const 0) $50 $11 $5 $23 $12)
 ...
 (export "_ZN5eosio5token6updateENS_5assetE" (func $11))
 ...
 (func $33 (; 50 ;) (type $21) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
  (i64.store offset=8
 ...
 (func $34 (; 51 ;) (type $1) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (set_local $2
   (i32.load
 ...
 (func $35 (; 52 ;) (type $1) (param $0 i32) (param $1 i32)
  (local $2 i64)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $38 (; 55 ;) (type $1) (param $0 i32) (param $1 i32)
  (local $2 i64)
  (local $3 i32)
  (local $4 i32)
  (i32.store offset=4
