(module
 ...
 (memory $0 1)
 (data (i32.const 8192) "id_order: \00")
 (data (i32.const 8203) " | date: \00malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (data (i32.const 8299) " | user: \00")
 (data (i32.const 8309) "read\00")
 (table $0 2 2 anyfunc)
 (elem (i32.const 1) $2)
 (global $global$0 (mut i32) (i32.const 8192))
 (global $global$1 i32 (i32.const 16720))
 (global $global$2 i32 (i32.const 16720))
 ...
 (func $2 (; 13 ;) (type $0) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i32)
  (local $4 i64)
  (set_local $4
   (call $fimport$4)
  )
 ...
 (func $5 (; 16 ;) (type $11) (param $0 i32) (result i32)
  (call $6
   (i32.const 8324)
   (get_local $0)
  )
 )
 (func $6 (; 17 ;) (type $2) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $7 (; 18 ;) (type $11) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
