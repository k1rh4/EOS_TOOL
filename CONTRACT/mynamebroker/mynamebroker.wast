(module
 ...
 (data (i32.const 32) "roulettespin\00")
 ...
 (func $7 (; 15 ;) (type $10) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
