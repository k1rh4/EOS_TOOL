(module
 ...
 (data (i32.const 8897) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 8961) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 9012) "error reading iterator\00")
 (data (i32.const 9035) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 9084) "read\00")
 (data (i32.const 9089) "cannot create objects in table of another contract\00")
 (data (i32.const 9140) "write\00")
 (data (i32.const 9146) "object passed to modify is not in multi_index\00")
 (data (i32.const 9192) "cannot modify objects in table of another contract\00")
 (data (i32.const 9243) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 9302) "attempt to add asset with different symbol\00")
 (data (i32.const 9345) "addition underflow\00")
 (data (i32.const 9364) "addition overflow\00")
 (data (i32.const 9382) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9430) "subtraction underflow\00")
 (data (i32.const 9452) "subtraction overflow\00")
 (data (i32.const 9473) "cannot pass end iterator to modify\00")
 (data (i32.const 9508) "cannot pass end iterator to erase\00")
 (data (i32.const 9542) "cannot increment end iterator\00")
 ...
 (data (i32.const 9720) "get\00")
 (table $0 7 7 anyfunc)
 (elem (i32.const 1) $14 $1 $16 $11 $18 $6)
 (global $global$0 (mut i32) (i32.const 8192))
 (global $global$1 i32 (i32.const 18132))
 (global $global$2 i32 (i32.const 18132))
 ...
 (func $16 (; 54 ;) (type $1) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i64)
  (local $7 i32)
 ...
 (func $18 (; 56 ;) (type $2) (param $0 i32) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $20 (; 58 ;) (type $28) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i64)
  (set_global $global$0
   (tee_local $3
 ...
 (func $21 (; 59 ;) (type $14) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $40 (; 78 ;) (type $23) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (block $label$1
   (br_if $label$1
 ...
 (func $42 (; 80 ;) (type $16) (param $0 i32)
  (block $label$1
   (br_if $label$1
    (i32.eqz
     (get_local $0)
 ...
 (func $47 (; 85 ;) (type $16) (param $0 i32)
  (call $fimport$16)
  (unreachable)
 )
 ...
 (func $50 (; 88 ;) (type $14) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $52 (; 90 ;) (type $16) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (block $label$1
