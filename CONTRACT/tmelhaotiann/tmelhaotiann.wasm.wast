(module
 ...
 (type $6 (func (param i64 i64 i32) (result i32)))
 ...
 (func $1 (; 8 ;) (type $5) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (set_global $global$0
   (tee_local $3
    (i32.sub
 ...
 (func $2 (; 9 ;) (type $0) (param $0 i32) (param $1 i32)
  (block $label$1
   (br_if $label$1
    (i64.ge_u
     (i64.load offset=96
 ...
 (func $3 (; 10 ;) (type $6) (param $0 i64) (param $1 i64) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $4 (; 11 ;) (type $0) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $5 (; 12 ;) (type $7) (param $0 i32)
 )
 (func $6 (; 13 ;) (type $8) (param $0 i32) (result i32)
  (call $7
   (i32.const 8208)
   (get_local $0)
  )
 )
 (func $7 (; 14 ;) (type $2) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $8 (; 15 ;) (type $8) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
