(module
 ...
 (data (i32.const 8463) "fairdogegame\00")
 ...
 (data (i32.const 8725) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 8789) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 8840) "error reading iterator\00")
 (data (i32.const 8863) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 8912) "read\00")
 (data (i32.const 8917) "cannot create objects in table of another contract\00")
 (data (i32.const 8968) "write\00")
 (data (i32.const 8974) "object passed to modify is not in multi_index\00")
 (data (i32.const 9020) "cannot modify objects in table of another contract\00")
 (data (i32.const 9071) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 9130) "attempt to add asset with different symbol\00")
 (data (i32.const 9173) "addition underflow\00")
 (data (i32.const 9192) "addition overflow\00")
 (data (i32.const 9210) "object passed to erase is not in multi_index\00")
 (data (i32.const 9255) "cannot erase objects in table of another contract\00")
 (data (i32.const 9305) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9358) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9406) "subtraction underflow\00")
 (data (i32.const 9428) "subtraction overflow\00")
 (data (i32.const 9449) "cannot pass end iterator to modify\00")
 (data (i32.const 9484) "get\00")
 (table $0 4 4 anyfunc)
 (elem (i32.const 1) $1 $11 $6)
 ...
 (func $11 (; 47 ;) (type $2) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i64)
  (local $7 i32)
  (local $8 i64)
 ...
 (func $16 (; 52 ;) (type $25) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i64)
  (set_global $global$0
   (tee_local $3
 ...
 (func $18 (; 54 ;) (type $13) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $32 (; 68 ;) (type $20) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (block $label$1
   (br_if $label$1
 ...
 (func $33 (; 69 ;) (type $20) (param $0 i32) (result i32)
  (call $32
   (get_local $0)
  )
 )
 (func $34 (; 70 ;) (type $11) (param $0 i32)
  (block $label$1
   (br_if $label$1
    (i32.eqz
     (get_local $0)
 ...
 (func $35 (; 71 ;) (type $11) (param $0 i32)
  (call $34
   (get_local $0)
  )
 )
 (func $36 (; 72 ;) (type $11) (param $0 i32)
  (call $fimport$14)
  (unreachable)
 )
 ...
 (func $38 (; 74 ;) (type $5) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $40 (; 76 ;) (type $11) (param $0 i32)
 )
 (func $41 (; 77 ;) (type $20) (param $0 i32) (result i32)
  (call $42
   (i32.const 9500)
   (get_local $0)
  )
