(module
 ...
 (data (i32.const 8651) "cannot recall to self\00")
 (data (i32.const 8673) "must transfer positive quantity\00")
 (data (i32.const 8705) "cannot transfer to self\00")
 (data (i32.const 8729) "to account does not exist\00")
 (data (i32.const 8755) "no balance object found\00")
 (data (i32.const 8779) "overdrawn balance\00")
 (data (i32.const 8797) "symbol does not exist\00")
 (data (i32.const 8819) "Balance row already deleted or never existed. Action won\'t have any effect.\00")
 (data (i32.const 8895) "Cannot close because the balance is not zero.\00")
 (data (i32.const 8941) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 8992) "error reading iterator\00")
 (data (i32.const 9015) "read\00")
 (data (i32.const 9020) "cannot create objects in table of another contract\00")
 (data (i32.const 9071) "write\00")
 ...
 (data (i32.const 9233) "attempt to add asset with different symbol\00")
 (data (i32.const 9276) "addition underflow\00")
 (data (i32.const 9295) "addition overflow\00")
 (data (i32.const 9313) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9361) "subtraction underflow\00")
 (data (i32.const 9383) "subtraction overflow\00")
 (data (i32.const 9404) "cannot pass end iterator to modify\00")
 (data (i32.const 9439) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 9488) "cannot pass end iterator to erase\00")
 (data (i32.const 9522) "cannot increment end iterator\00")
 (data (i32.const 9552) "object passed to erase is not in multi_index\00")
 (data (i32.const 9597) "cannot erase objects in table of another contract\00")
 (data (i32.const 9647) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9700) "get\00")
 (table $0 8 8 anyfunc)
 (elem (i32.const 1) $19 $10 $1 $16 $17 $5 $13)
 ...
 (func $13 (; 52 ;) (type $2) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i64)
  (local $6 i32)
  (local $7 i64)
 ...
 (func $16 (; 55 ;) (type $3) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i64)
  (local $7 i32)
  (local $8 i64)
