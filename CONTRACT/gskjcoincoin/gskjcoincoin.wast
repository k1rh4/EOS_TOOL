(module
 ...
 (data (i32.const 8682) "g123llkk1234\00")
 (data (i32.const 8695) "yangshuaiwen\00")
 (data (i32.const 8708) "eoscodingman\00")
 (data (i32.const 8721) "eositlticoin\00")
 (data (i32.const 8734) "to account does not register!\00")
 (data (i32.const 8764) "unable to find key\00")
 (data (i32.const 8783) "must transfer positive quantity\00")
 (data (i32.const 8815) "no balance object found\00")
 (data (i32.const 8839) "overdrawn balance\00")
 (data (i32.const 8857) "symbol does not exist\00")
 (data (i32.const 8879) "Balance row already deleted or never existed. Action won\'t have any effect.\00")
 (data (i32.const 8955) "Cannot close because the balance is not zero.\00")
 (data (i32.const 9004) "0#\00\00")
 (data (i32.const 9008) ".12345abcdefghijklmnopqrstuvwxyz\00")
 (data (i32.const 9041) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 9092) "error reading iterator\00")
 (data (i32.const 9115) "read\00")
 (data (i32.const 9120) "cannot create objects in table of another contract\00")
 ...
 (data (i32.const 9333) "attempt to add asset with different symbol\00")
 (data (i32.const 9376) "addition underflow\00")
 (data (i32.const 9395) "addition overflow\00")
 (data (i32.const 9413) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9461) "subtraction underflow\00")
 (data (i32.const 9483) "subtraction overflow\00")
 (data (i32.const 9504) "cannot pass end iterator to modify\00")
 (data (i32.const 9539) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 9588) "cannot pass end iterator to erase\00")
 (data (i32.const 9622) "cannot increment end iterator\00")
 (data (i32.const 9652) "object passed to erase is not in multi_index\00")
 (data (i32.const 9697) "cannot erase objects in table of another contract\00")
 (data (i32.const 9747) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9800) "get\00")
 (table $0 7 7 anyfunc)
