(module
 ...
 (data (i32.const 112) "GO! \00")
 (data (i32.const 128) "read\00")
 (data (i32.const 144) "HI \00")
 ...
 (func $8 (; 16 ;) (type $0) (param $0 i32) (param $1 i64)
  (call $fimport$4
   (i32.const 112)
  )
  (call $fimport$5
 ...
 (func $13 (; 21 ;) (type $8) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (set_local $5
