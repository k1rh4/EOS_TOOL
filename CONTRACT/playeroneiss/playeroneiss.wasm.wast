(module
 ...
 (data (i32.const 8712) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 8776) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 8827) "error reading iterator\00")
 (data (i32.const 8850) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 8899) "read\00")
 (data (i32.const 8904) "cannot create objects in table of another contract\00")
 (data (i32.const 8955) "write\00")
 ...
 (data (i32.const 9117) "attempt to add asset with different symbol\00")
 (data (i32.const 9160) "addition underflow\00")
 (data (i32.const 9179) "addition overflow\00")
 (data (i32.const 9197) "object passed to erase is not in multi_index\00")
 (data (i32.const 9242) "cannot erase objects in table of another contract\00")
 (data (i32.const 9292) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9345) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9393) "subtraction underflow\00")
 (data (i32.const 9415) "subtraction overflow\00")
 (data (i32.const 9436) "cannot pass end iterator to modify\00")
 (data (i32.const 9471) "get\00")
 (table $0 4 4 anyfunc)
