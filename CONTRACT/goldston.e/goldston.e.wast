(module
 ...
 (data (i32.const 8712) "invalid amount\00")
 (data (i32.const 8727) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 8791) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 8840) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 8891) "error reading iterator\00")
 (data (i32.const 8914) "read\00")
 (data (i32.const 8919) "cannot create objects in table of another contract\00")
 (data (i32.const 8970) "write\00")
 ...
 (data (i32.const 9073) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 9132) "attempt to add asset with different symbol\00")
 (data (i32.const 9175) "addition underflow\00")
 (data (i32.const 9194) "addition overflow\00")
 (data (i32.const 9212) "object passed to erase is not in multi_index\00")
 (data (i32.const 9257) "cannot erase objects in table of another contract\00")
 (data (i32.const 9307) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9360) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9408) "subtraction underflow\00")
 (data (i32.const 9430) "subtraction overflow\00")
 (data (i32.const 9451) "cannot pass end iterator to modify\00")
 (data (i32.const 9486) "get\00")
 (table $0 5 5 anyfunc)
 (elem (i32.const 1) $11 $1 $16 $6)
 ...
 (func $17 (; 53 ;) (type $25) (param $0 i64) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i64)
  (set_global $global$0
   (tee_local $3
 ...
 (func $34 (; 70 ;) (type $20) (param $0 i32) (result i32)
  (call $33
   (get_local $0)
  )
 )
 ...
 (func $39 (; 75 ;) (type $5) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $42 (; 78 ;) (type $20) (param $0 i32) (result i32)
  (call $43
   (i32.const 9504)
   (get_local $0)
  )
