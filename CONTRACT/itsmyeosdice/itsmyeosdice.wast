(module
 ...
 (data (i32.const 512) "diceeostoken\00")
 ...
 (data (i32.const 1120) "eos amount must bee at range [0.1, 10] EOS\00")
 (data (i32.const 1168) "det amount must bee at 100 DET\00")
 (data (i32.const 1200) "roll_under must bee in range[2,96]\00")
 (data (i32.const 1248) "reveal\00")
 (data (i32.const 1264) "airdrop_rate must bee in range[0, 1000000]\00")
 (data (i32.const 1312) "&\00")
 (data (i32.const 1328) "=\00")
 (data (i32.const 1344) "opt\00")
 (data (i32.const 1360) "roll_under\00")
 (data (i32.const 1376) "airdrop_rate\00")
 (data (i32.const 1392) "nonce\00")
 (data (i32.const 1408) "invalid quantity\00")
 (data (i32.const 1440) "eosio.token\00")
 (data (i32.const 1456) "bet\00")
 (data (i32.const 1472) "set_airdrop_rate\00")
 (data (i32.const 1504) "mydappmydapp\00")
