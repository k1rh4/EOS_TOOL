(module
 ...
 (func $124 (; 168 ;) (type $29) (param $0 i32) (result i32)
  ...
  (block $label$1
   ...
   (i32.store8 offset=10392
    (i32.const 0)
    (i32.const 1)
   )
   (i32.store offset=10396
    (i32.const 0)
    (tee_local $2
     (i32.shl
      (get_local $2)
