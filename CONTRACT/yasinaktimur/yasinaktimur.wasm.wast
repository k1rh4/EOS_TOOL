(module
 ...
 (memory $0 1)
 (data (i32.const 8192) "Hi from decentral solutions, \00")
 (data (i32.const 8222) "read\00malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (table $0 2 2 anyfunc)
 (elem (i32.const 1) $2)
 ...
 (func $2 (; 11 ;) (type $0) (param $0 i32) (param $1 i64)
  (call $fimport$4
   (i32.const 8192)
  )
  (call $fimport$5
 ...
 (func $3 (; 12 ;) (type $9) (param $0 i64) (param $1 i64) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $5 (; 14 ;) (type $10) (param $0 i32) (result i32)
  (call $6
   (i32.const 8324)
   (get_local $0)
  )
 )
 (func $6 (; 15 ;) (type $2) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $7 (; 16 ;) (type $10) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
