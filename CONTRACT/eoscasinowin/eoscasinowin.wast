(module
 ...
 (data (i32.const 8536) "cannot transfer to self\00")
 (data (i32.const 8560) "to account does not exist\00")
 (data (i32.const 8586) "unable to find key\00")
 (data (i32.const 8605) "must transfer positive quantity\00")
 (data (i32.const 8637) "no balance object found\00")
 (data (i32.const 8661) "overdrawn balance\00")
 (data (i32.const 8679) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 8743) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 8794) "error reading iterator\00")
 (data (i32.const 8817) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 8866) "read\00")
 (data (i32.const 8871) "object passed to modify is not in multi_index\00")
 (data (i32.const 8917) "cannot modify objects in table of another contract\00")
 (data (i32.const 8968) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 9027) "write\00")
 (data (i32.const 9033) "cannot create objects in table of another contract\00")
 (data (i32.const 9084) "attempt to add asset with different symbol\00")
 (data (i32.const 9127) "addition underflow\00")
 (data (i32.const 9146) "addition overflow\00")
 (data (i32.const 9164) "object passed to erase is not in multi_index\00")
 (data (i32.const 9209) "cannot erase objects in table of another contract\00")
 (data (i32.const 9259) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 9312) "attempt to subtract asset with different symbol\00")
 (data (i32.const 9360) "subtraction underflow\00")
 (data (i32.const 9382) "subtraction overflow\00")
 (data (i32.const 9403) "cannot pass end iterator to modify\00")
 (data (i32.const 9438) "get\00")
 (table $0 4 4 anyfunc)
 (elem (i32.const 1) $1 $11 $6)
 (global $global$0 (mut i32) (i32.const 8192))
 (global $global$1 i32 (i32.const 17852))
 (global $global$2 i32 (i32.const 17852))
 ...
 (func $4 (; 40 ;) (type $20) (param $0 i32) (result i32)
  (local $1 i64)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
