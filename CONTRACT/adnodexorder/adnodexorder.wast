(module
 ...
 (memory $0 1)
 (data (i32.const 8192) "order_reference: \00")
 (data (i32.const 8210) " | date: \00malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (data (i32.const 8306) " | user: \00")
