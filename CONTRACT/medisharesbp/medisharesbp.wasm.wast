(module
 ...
 (data (i32.const 992) "token with symbol does not exist, create token before signup\00")
 (data (i32.const 1056) "you have already signed up\00")
 (data (i32.const 1088) "quantity exceeds signup allowance\00")
 (data (i32.const 1136) "cannot transfer to self\00")
 (data (i32.const 1168) "to account does not exist\00")
 (data (i32.const 1200) "unable to find key\00")
 (data (i32.const 1232) "must transfer positive quantity\00")
 ...
 (table $0 5 5 anyfunc)
 (elem (i32.const 0) $48 $23 $5 $22 $11)
 ...
 (export "_ZN5eosio5token6signupEyNS_5assetE" (func $22))
 ...
 (func $22 (; 39 ;) (type $0) (param $0 i32) (param $1 i64) (param $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i64)
  (local $6 i32)
 ...
 (func $38 (; 55 ;) (type $12) (param $0 i32)
  (block $label$1
   (br_if $label$1
    (i32.eqz
     (get_local $0)
