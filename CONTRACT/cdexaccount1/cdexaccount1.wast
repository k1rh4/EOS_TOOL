(module
 ...
 (memory $0 1)
 (data (i32.const 8192) "Hello STUPID \00")
 (data (i32.const 8206) "read\00malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 (table $0 2 2 anyfunc)
 (elem (i32.const 1) $2)
