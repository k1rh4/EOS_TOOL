(module
 ...
 (data (i32.const 1056) "must transfer positive quantity\00")
 (data (i32.const 1088) "no balance object found\00")
 (data (i32.const 1120) "overdrawn balance\00")
 (data (i32.const 1152) "kingdomdivid\00")
 (data (i32.const 1168) "cannot transfer over staked amount!\00")
 ...
 (func $29 (; 46 ;) (type $16) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
